    ...
    <div class="album py-5 bg-light">
      <div class="container">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          ...
          $lng = $_COOKIE['lng'];
          //echo $search;
          $sql = "SELECT * FROM resturants ORDER BY CASE WHEN  ResturantName lIKE '$search%' THEN 1 else 2 END";
          ...
          while ($row = mysqli_fetch_array($rs)) {
            ...
            echo '<div class="card-body">
                  ...
                  <div id="myModal' . $row["id"] . '" class="modal w3-animate-zoom" stlye="opacity: 30%;">
                    ...
                    echo " <img src='data:image/jpeg;base64," . base64_encode($row["Logo"]) . "' ' style='width: 50%;height: 50%;' onclick='openModal".$row["id"]."();currentSlide(1)' class='hover-shadow cursor' />";
                    echo "
                    ...
                    echo "</div>
                      ...
                      function currentSlide(n) {
                        showSlides(slideIndex'.$row["id"].' = 1);
                      }
